 ...
 */
static const char * const WIN_BG_COLOR = "#050203";
static const char * const WIN_FS_COLOR = "#000000";
static const char * const SEL_COLOR    = "#DDDDDD";
static const char * const BAR_BG_COLOR = "#A7341B";
...
static const float zoom_levels[] = {
	10.0, 15.0,  20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0, 60.0, 65.0, 70.0, 75.0, 80.0, 85.0, 90.0, 95.0, 100.0, 105.0, 110.0, 115.0, 120.0, 125.0, 130.0, 135.0, 140.0, 145.0, 150.0, 155.0, 160.0, 165.0, 170.0, 175.0, 180.0, 185.0, 190.0, 195.0, 200.0, 225.0, 250.0, 300.0, 350.0, 400.0, 500.0, 600.0, 800.0
};
...
static const button_t buttons[] = {
	...
	{ false,  false,  Button2,  i_navigate,           (arg_t) +1 },
	{ false,  false,  Button3,  i_navigate,           (arg_t) -1 },
	{ false,  false,  Button1,  i_drag,               (arg_t) None },
	{ false,  false,  Button4,  it_scroll_move,       (arg_t) DIR_UP },
	{ false,  false,  Button5,  it_scroll_move,       (arg_t) DIR_DOWN },
	{ false,  true,   Button6,  it_scroll_move,       (arg_t) DIR_LEFT },
	{ false,  true,   Button7,  it_scroll_move,       (arg_t) DIR_RIGHT },
